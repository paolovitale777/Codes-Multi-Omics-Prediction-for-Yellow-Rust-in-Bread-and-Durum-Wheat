...
results_file = os.path.join(output_dir, "SVR_score1_bw_CVnested_markers_plus_waves.csv")
...
plt.tight_layout()
plot_file = os.path.join(output_dir, "SVR_score1_bw_CVnested_markers_plus_waves.png")
